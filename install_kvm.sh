...
--extra-args='ks=file:/Kickstarter.cfg console=ttyS0,115200n8'
...
# sudo virt-install --name test1 --connect qemu:///system --ram 16384 --disk path=ubuntu.qcow2 --vcpus 16 --os-type linux --network network=default --graphics none --location=ubuntu-16.04.6-server-amd64.iso --initrd-inject kvm/cluster-template/Kickstarter.cfg --extra-args="ks=file:/Kickstarter.cfg console=ttyS0,115200n8 serial"
